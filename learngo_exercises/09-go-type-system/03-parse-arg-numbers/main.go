...
func main() {
	...
	ex1, _ := strconv.ParseInt(os.Args[2], 10, 16)

	fmt.Println("int16 value is:", int16(ex1))
	// 2. Get an int32 value using ParseInt and convert it and print it
	ex2, _ := strconv.ParseInt(os.Args[3], 10, 32)

	fmt.Println("int32 value is:", int32(ex2))
	// 3. Get an int64 value using ParseInt and convert it and print it
	ex3, _ := strconv.ParseInt(os.Args[4], 10, 64)

	fmt.Println("int64 value is:", ex3)
	// 4. Get an int8 value using ParseInt and convert it and print it
	//    But this time, get the value in bits.
	//
	//    For example : 00000100
	//    Should print: 4
	ex4, _ := strconv.ParseInt(os.Args[5], 2, 8)

	fmt.Printf("%s is: %d",os.Args[5] , int8(ex4))
}
